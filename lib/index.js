                        ...
                        type: new _graphql.GraphQLObjectType({
                            ...
                            fields: function fields() {
                                ...
                                return CreateFields(type, KeyedList(type), function (fieldResolver, key, obj) {
                                    return (0, _immutable.List)(obj).groupBy(function (ii) {
                    ...
                    return fields.merge((0, _immutable.Map)({
                            ...
                            type: new _graphql.GraphQLObjectType({
                                ...
                                fields: function fields() {
                                    return CreateFields(type, _graphql.GraphQLFloat, function (fieldResolver, key, obj) {
                                        return (0, _immutable.List)(obj).update(imMath.sumBy(function (ii) {
                                            return fieldResolver(ii);
                                        }));
                                    }, function (field) {
                                        return isFloat(field) || isInt(field);
                        ...
                        average: {
                            ...
                            type: new _graphql.GraphQLObjectType({
                                ...
                                fields: function fields() {
                                    return CreateFields(type, _graphql.GraphQLFloat, function (fieldResolver, key, obj) {
                                        return (0, _immutable.List)(obj).update(imMath.averageBy(function (ii) {
                                            return fieldResolver(ii);
                                        }));
                                    }, function (field) {
                                        return isFloat(field) || isInt(field);
                        ...
                        median: {
                            ...
                            type: new _graphql.GraphQLObjectType({
                                ...
                                fields: function fields() {
                                    return CreateFields(type, _graphql.GraphQLFloat, function (fieldResolver, key, obj) {
                                        return (0, _immutable.List)(obj).update(imMath.medianBy(function (ii) {
                                            return fieldResolver(ii);
                                        }));
                                    }, function (field) {
                                        return isFloat(field) || isInt(field);
                        ...
                        min: {
                            ...
                            type: new _graphql.GraphQLObjectType({
                                ...
                                fields: function fields() {
                                    return CreateFields(type, _graphql.GraphQLFloat, function (fieldResolver, key, obj) {
                                        return (0, _immutable.List)(obj).update(imMath.minBy(function (ii) {
                                            return fieldResolver(ii);
                                        }));
                                    }, function (field) {
                                        return isFloat(field) || isInt(field);
                        ...
                        max: {
                            ...
                            type: new _graphql.GraphQLObjectType({
                                ...
                                fields: function fields() {
                                    return CreateFields(type, _graphql.GraphQLFloat, function (fieldResolver, key, obj) {
                                        return (0, _immutable.List)(obj).update(imMath.maxBy(function (ii) {
                                            return fieldResolver(ii);
                                        }));
                                    }, function (field) {
                                        return isFloat(field) || isInt(field);
