        ...
        if (typeCheck(field)) {
            return resultFields.set(key, (0, _immutable.Map)({
                ...
                resolve: function resolve(obj, args, ctx) {
                    console.log('Field Config and args context', field, args, ctx);
                    return resolver(fieldResolver(field, key)(args, ctx), key, obj, field);
                }
            }));
        }
        return resultFields;
...
function createFieldsFromFieldList(fields, returnType, resolver) {
    return (0, _immutable.fromJS)(fields).reduce(function (resultFields, field, key) {
        return resultFields.set(key, (0, _immutable.Map)({
            ...
            resolve: function resolve(obj, args, ctx) {
                console.log('Field Config and args context', field, args, ctx);
                //fieldResolver gets the real resolve, needs to be called with more params
                return resolver(fieldResolver(field, key)(args, ctx), key, obj, field);
            }
        }));
    }, (0, _immutable.Map)()).toJS();
...
var resolveIntFilter = function resolveIntFilter(field, key) {
    return function (obj, args) {
        return (0, _immutable.List)(obj).filter(function (ii) {
            return runFilterFunction(field, key)(args, ii);
        });
    };
};
            ...
            fields: function fields() {
                        ...
                        type: new _graphql.GraphQLObjectType({
                            ...
                            fields: function fields() {
                                ...
                                return createFields(type, KeyedList(type), function (fieldResolver, key, obj) {
                                    return (0, _immutable.List)(obj).groupBy(fieldResolver).map(function (ii) {
                                        return ii.toArray();
                                    });
                                }, function () {
                                    return true;
                ...
                if (stringFields.count() > 0 || intFields.count() > 0) {
                    ...
                    if (intFields.count() > 0) {
                        ...
                        return fields.merge((0, _immutable.Map)({
                            sum: {
                                ...
                                type: new _graphql.GraphQLObjectType({
                                    ...
                                    fields: function fields() {
                                        return createFieldsFromFieldList(intFields, _graphql.GraphQLFloat, function (fieldResolver, key, obj) {
                                            return (0, _immutable.List)(obj).update(imMath.sumBy(fieldResolver));
                                        }, function (field) {
                                            return isFloat(field) || isInt(field);
                                        });
                                    }
                            ...
                            average: {
                                ...
                                type: new _graphql.GraphQLObjectType({
                                    ...
                                    fields: function fields() {
                                        return createFieldsFromFieldList(intFields, _graphql.GraphQLFloat, function (fieldResolver, key, obj) {
                                            return (0, _immutable.List)(obj).update(imMath.averageBy(fieldResolver));
                                        }, function (field) {
                                            return isFloat(field) || isInt(field);
                                        });
                                    }
                            ...
                            median: {
                                ...
                                type: new _graphql.GraphQLObjectType({
                                    ...
                                    fields: function fields() {
                                        return createFieldsFromFieldList(intFields, _graphql.GraphQLFloat, function (fieldResolver, key, obj) {
                                            return (0, _immutable.List)(obj).update(imMath.medianBy(fieldResolver));
                                        }, function (field) {
                                            return isFloat(field) || isInt(field);
                                        });
                                    }
                            ...
                            min: {
                                ...
                                type: new _graphql.GraphQLObjectType({
                                    ...
                                    fields: function fields() {
                                        return createFieldsFromFieldList(intFields, _graphql.GraphQLFloat, function (fieldResolver, key, obj) {
                                            return (0, _immutable.List)(obj).update(imMath.minBy(fieldResolver));
                                        }, function (field) {
                                            return isFloat(field) || isInt(field);
                                        });
                                    }
                            ...
                            max: {
                                ...
                                type: new _graphql.GraphQLObjectType({
                                    ...
                                    fields: function fields() {
                                        return createFieldsFromFieldList(intFields, _graphql.GraphQLFloat, function (fieldResolver, key, obj) {
                                            return (0, _immutable.List)(obj).update(imMath.maxBy(fieldResolver));
                                        }, function (field) {
                                            return isFloat(field) || isInt(field);
                                        });
                                    }
