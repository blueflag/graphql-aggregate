...
var filterFunctions = {
    ...
    not: function not(_ref6, value) {
        var _not = _ref6.not;

        return _not == null || !runFilterFunction(_not, value);
    },
    or: function or(_ref7, value) {
        var _or = _ref7.or;
...
var runFilterFunction = function runFilterFunction(field) {
    return function (args, ii) {
        return filterFunctions.gt(args, field.get('resolve')(ii)) && filterFunctions.lt(args, field.get('resolve')(ii)) && filterFunctions.gte(args, field.get('resolve')(ii)) && filterFunctions.lte(args, field.get('resolve')(ii)) && filterFunctions.equal(args, field.get('resolve')(ii)) && filterFunctions.not(args, field.get('resolve')(ii)) && filterFunctions.or(args, field.get('resolve')(ii));
    };
};

var resolveIntFilter = function resolveIntFilter(field) {
    return function (obj, args) {
        return (0, _immutable.fromJS)(obj).filter(function (ii) {
            return runFilterFunction(field)(args, ii);
        }).toJS();
    };
};
            ...
            fields: function fields() {
                return {
                    ...
                    first: {
                        ...
                        type: type,
                        resolve: function resolve(obj) {
                            return (0, _immutable.fromJS)(obj).first();
                        }
                    },
                    last: {
                        ...
                        type: type,
                        resolve: function resolve(obj) {
                            return (0, _immutable.fromJS)(obj).last();
                        }
                    },
                    reverse: {
                        ...
                        type: AggregationType(type),
                        resolve: function resolve(obj) {
                            return (0, _immutable.fromJS)(obj).reverse();
                        }
                    },
                    //slice: {}
                    //sort: {}
