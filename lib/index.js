...
var filterFunctions = function filterFunctions(field) {
    return {
        ...
        not: function not(_ref6, value, obj) {
            ...
            return _not == null || !runFilterFunction(field)(_not, obj);
        }
    };
};
...
var runFilterFunction = function runFilterFunction(field) {
    return function (args, ii) {
        return filterFunctions(field).gt(args, field.get('resolve')(ii)) && filterFunctions(field).lt(args, field.get('resolve')(ii)) && filterFunctions(field).gte(args, field.get('resolve')(ii)) && filterFunctions(field).lte(args, field.get('resolve')(ii)) && filterFunctions(field).equal(args, field.get('resolve')(ii)) && filterFunctions(field).not(args, field.get('resolve')(ii), ii);
...
var resolveIntFilter = function resolveIntFilter(field) {
    return function (obj, args) {
        return (0, _immutable.fromJS)(obj).filter(function (ii) {
            return runFilterFunction(field)(args, ii.toJS());
        }).toJS();
    };
};
